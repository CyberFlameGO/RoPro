...
function fetchPopularToday() {
	return new Promise(resolve => {
		chrome.runtime.sendMessage({greeting: "GetURL", url:"https://ropro.io/api/getMostPopularToday.php"},
			function(data) {
				resolve(data)
		})
	})
...
function addPopularGame(universeId, gameName, gameLink, gameIcon, hours) {
    ...
    <img style="background-image:none;margin:-6px;margin-top:0px;margin-bottom:0.5px;transform:scale(0.4);border:none;margin-left:-8px;margin-top:-0.6px;margin-right:-9px;" src="https://ropro.io/images/timericon_${stripTags(clocktheme)}.png" class="info-label icon-pastname"><span style="font-size:10.5px;" title="Played for ${addCommas(parseInt(hours).toString())} hours by RoPro users in the last 24 hours" class="info-label vote-percentage-label">${kFormatter(parseInt(hours))} Hours Today</span>
    </div></a></div></li>`
